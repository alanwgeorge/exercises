...
class EspressoMachine(scope: CoroutineScope): CoroutineScope by scope {
    ...
    private val portafilterOne = actor<PullEspressoShotRequest>() {
        consumeEach {
    ...
    private val portafilterTwo = actor<PullEspressoShotRequest>() {
        consumeEach {
    ...
    private val steamWandOne = actor<SteamMilkRequest>() {
        consumeEach {
    ...
    private val steamWandTwo = actor<SteamMilkRequest>() {
        consumeEach {
